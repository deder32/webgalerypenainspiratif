				...
				<a id="Author" href="{{ route('front.author', $post->author->slug) }}" class="w-fit h-fit">
					<div class="flex items-center gap-3">
						<div class="w-10 h-10 overflow-hidden rounded-full">
							<img src="{{ Storage::url($post->author->avatar) }}" class="object-cover w-full h-full" alt="avatar">
						</div>
	...
	<section id="Advertisement" class="max-w-[1130px] mx-auto flex justify-center mt-[70px]">
		<div class="flex flex-col gap-3 shrink-0 w-fit">
			<a href="{{ $banner_advertisements->link }}">
				<div class="w-[900px] h-auto flex shrink-0 border border-[#EEF0F7] rounded-2xl overflow-hidden">
